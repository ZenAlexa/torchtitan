...
class RematAC(ActivationCheckpointing):
    ...
    class Config(ActivationCheckpointing.Config):
        ...
        """
        Allow save-region patterns that do not match this model part. This may
        be needed with pipeline parallelism when a pattern only matches regions
        assigned to another stage. Unmatched patterns still emit a warning.
        """
